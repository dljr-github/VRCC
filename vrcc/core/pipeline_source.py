"""Live source-delegation helpers for the pipeline: denoise pushes to the
current audio source. Module functions take the Pipeline instance ``p``;
only the per-call delegation logic lives here, mirroring pipeline_jobs.
